...
If your StripChat account has access to paid private streams and you want the recorder to keep trying when the room status becomes private, set `STRMNTR_STRIPCHAT_RECORD_PRIVATE=true`.
